...
{
    public partial class PortafolioLubricantesDetalle
    {
        public PortafolioLubricantesDetalle()
        {
            PortafolioLubricantes = new HashSet<PortafolioLubricantes>();
        }
        ...
        public virtual ICollection<PortafolioLubricantes> PortafolioLubricantes { get; set; }
    }
}
