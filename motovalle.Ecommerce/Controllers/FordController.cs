// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FordController.cs" company="Innova Marketing Systems S.A.S">
//   © All rights reserved
// </copyright>
// <summary>
//  Ford Controller
...
namespace motovalle.Ecommerce.Controllers
{
    ...
    public class FordController : Controller
    {
        ...
        public FordController(IConfiguration configuration)
        {
            ...
            try
            {
                this._make = makesApi.GetRecord("Ford").Result;
        ...
        /// </summary>
        /// <returns>Ford Index View</returns>
        [HttpGet]
