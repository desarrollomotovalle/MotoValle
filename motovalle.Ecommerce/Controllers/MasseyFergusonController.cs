// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MasseyFergusonController.cs" company="Innova Marketing Systems S.A.S">
//   © All rights reserved
// </copyright>
// <summary>
//  Massey Ferguson Controller
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace motovalle.Ecommerce.Controllers
{
    ...
    [AllowAnonymous]
    public class MasseyFergusonController : Controller
    {
        /// <summary>
        ...
        public MasseyFergusonController(IConfiguration configuration)
        {
            ...
            try
            {
                this._make = makesApi.GetRecord("Massey Ferguson").Result;
                this._categories = categoriesApi.GetAllRecords().Result;
                this._headquartersViewModel = this._headquartersViewModel.Where(x => x.Make == "Massey Ferguson").ToList();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns>Massey ferguson index view</returns>
        [HttpGet]
        ...
        public async Task<IActionResult> ProductDetails(int productId, int inventoryItemsId)
        {
            ...
            ViewBag.Make = this._make.MakeName;
